        ...
        public List<AgentDataNew> GetListAgentNew()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    string query = @"SELECT e.PayeeID, e.Name, e.JoinDate, e.Title, e.EmailAddress,
                    e.Address, e.RecruitBy, e.RecruiterName, e.AMCode, e.AMName, 
                    e.SAMCode, e.SAMName, e.ADCode, e.ADNAme, e.GAOfficeCode, 
                    e.GAOfficeName, e.No_Identitas, e.LicenseID, e.Phone, e.EmployeeStatus,
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        while (dr.Read())
                        {
                            ...
                            data.No_Identitas =SafeGetString(dr, 16);
